...
label = Label(root, text="Welcome to Tennis Ladder", font=('Tahoma 25 bold'), bg='grey', fg='#FFC331')
canvas.create_window(260, 40, anchor="nw", window=label)
user_label = Label(root, text="Χρήστης:", font=("Tahoma 18 bold"), bg='grey', fg='#FFC331').place(x=166, y=130)
canvas.create_window(140, 130, anchor="nw", window=user_label)
password_label = Label(root, text="Κωδικός:", font=("Τahoma 18 bold"), bg='grey', fg='#FFC331').place(x=170, y=200)
